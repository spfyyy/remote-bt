...
u8_array bencoded_dictionary = {
	(uint8_t *)"d4:testli1ei23ei456ee5:test23:lole",
	34
};
...
int32_t verify_u8_arrays_are_equal(u8_array actual, u8_array expected)
{
...
int32_t test_extract_bencode_string()
{
	u8_array expected = {
	...
	u8_array string;
	int32_t read_result = bencode_read_string(bencoded_dictionary, 1, &string);
	int32_t verify_result = verify_u8_arrays_are_equal(string, expected);
...
int32_t test_extract_bencode_number()
{
	u8_array expected = {
	...
	u8_array number;
	int32_t read_result = bencode_read_number(bencoded_dictionary, 15, &number);
	int32_t verify_result = verify_u8_arrays_are_equal(number, expected);
	if (read_result != 0 || verify_result != 0)
	{
...
int32_t test_extract_bencode_list()
{
	u8_array expected = {
	...
	u8_array list;
	int32_t read_result = bencode_read_list(bencoded_dictionary, 7, &list);
	int32_t verify_result = verify_u8_arrays_are_equal(list, expected);
	if (read_result != 0 || verify_result != 0)
	{
...
int32_t test_extract_bencode_dictionary()
{
	u8_array expected = {
	...
	u8_array dictionary;
	int32_t read_result = bencode_read_dictionary(bencoded_dictionary, 0, &dictionary);
	int32_t verify_result = verify_u8_arrays_are_equal(dictionary, expected);
	if (read_result != 0 || verify_result != 0)
	{
...
int32_t test_allocate_string_value()
{
...
int32_t test_get_value_for_key()
{
	u8_array value;
	int32_t result = bencode_get_value_for_key(bencoded_dictionary, "test2", 5, &value);
	...
	int32_t verify_result = verify_u8_arrays_are_equal(value, expected);
